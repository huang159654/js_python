...
CryptoJS.lib.Cipher || function (u) {
    var p = CryptoJS
        ...
        createEncryptor: function (e, a) {
            return this.create(this.IX6R, e, a)
        },
        createDecryptor: function (e, a) {
            return this.create(this.brB4F, e, a)
        },
        init: function (e, a, b) {
    ...
    d.BlockCipher = v.extend({
        ...
        reset: function () {
            ...
            var a = this.cfg
                , b = a.iv
                , a = a.mode;
            if (this.Vv0x == this.IX6R)
                var c = a.createEncryptor;
            else
                c = a.createDecryptor,
                    this.Vr0x = 1;
            this.eU3x = c.call(a, this, b && b.words)
        },
        tt9k: function (a, b) {
            this.eU3x.processBlock(a, b)
        },
        nZ7S: function () {
...
(function () {
        ...
        var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
            , d = d.AES = p.extend({
            mj6d: function () {
                for (var a = this.J2x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bbn1x = d + 6) + 1), e = this.bsf5k = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            encryptBlock: function (a, b) {
                this.DE2x(a, b, this.bsf5k, t, r, w, v, l)
            },
            decryptBlock: function (a, c) {
                var d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d;
                this.DE2x(a, c, this.bsg5l, b, x, q, n, s);
                d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d
            },
...
function mian(d) {
    d = '{"ids":"['+d+']","level":"standard","encodeType":"aac","csrf_token":""}'
    e = '010001'
